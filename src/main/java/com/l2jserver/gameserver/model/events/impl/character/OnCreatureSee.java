...
import static com.l2jserver.gameserver.model.events.EventType.ON_CREATURE_SEE;
...
public class OnCreatureSee implements IBaseEvent {
	...
	private final L2Character observer;
	
	private final L2Character observed;

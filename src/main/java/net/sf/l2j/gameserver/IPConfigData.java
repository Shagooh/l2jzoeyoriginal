...
public class IPConfigData implements IXmlReader {
    ...
    private static final Logger LOG = Logger.getLogger(IPConfigData.class.getName());
    ...
    public static IPConfigData getInstance() {
        return SingletonHolder.INSTANCE;
    }

    private static class SingletonHolder {
        protected static final IPConfigData INSTANCE = new IPConfigData();
    }
}